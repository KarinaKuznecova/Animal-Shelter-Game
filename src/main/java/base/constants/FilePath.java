...
public class FilePath {
    ...
    public static final String POTATO_IMG = "img/potato.png";
    public static final String POTATO_PREVIEW = "img/potato-preview.png";
    public static final String POTATO_SEEDS = "img/potato-seeds.png";
